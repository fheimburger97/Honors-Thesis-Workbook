---
title: "Final Project: The Socioeconomic and Food Reatil Landscape of San Francisco's Mission District"
...
```{r}
Test_businesses <- read_csv("TEST_Survey_Responses.csv") %>%
...
get_geodata_from_json_nominatim <- function(geodata_json) {
    ...
    lat_lng_a_c <- Test_businesses(lat = NA, lng = NA, address = NA, pub_name = NA,
