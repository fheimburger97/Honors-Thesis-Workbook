...
incomemap_2
tmap_save(incomemap_2_leaf, "attempt_1.html")
```
...
dots_quantity <- tm_basemap("OpenStreetMap") + tm_shape(primary_table_title) + tm_dots(size=.1, col="Number of Produce Options", palette="Set1")
incomemap_with_food_retailers <- tm_shape(incomejoin_test_title) +
             tm_style("watercolor") +
             tm_polygons("Median Household Income", alpha = .75) +
...
#### Maps
```{r}
dots_ethnic_section <- tm_basemap("OpenStreetMap") + tm_shape(primary_table_title) + tm_dots(size=.1, col="Latinx Ethnic Food Section?" , palette="Set1")
incomemap_with_food_retailers <- tm_shape(incomejoin_test_title) +
             tm_style("watercolor") +
             tm_polygons("Median Household Income", alpha = .75) +
