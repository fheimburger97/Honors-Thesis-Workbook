...
incomemap_2
tmap_save(incomemap_2_leaf, "attempt_1.png")
class(incomemap_2)
```
...
ethnicity_map_with_food_retailers <-
  ...
  tm_polygons("Majority Ethnicity") +
  tm_style("watercolor") +
...
dots_price <- tm_shape(primary_table_price_title) + tm_dots(size=.1, col="Price Quartile", palette="Set1", showNA = TRUE)
incomemap_with_food_retailers <- tm_shape(incomejoin_test_title) +
             tm_style("watercolor") +
             tm_polygons("Median Household Income") +
...
dots_quantity <- tm_shape(primary_table_title) + tm_dots(size=.1, col="Number of Produce Options", palette="Set1")
incomemap_with_food_retailers <- tm_shape(incomejoin_test_title) +
             tm_style("watercolor") +
             tm_polygons("Median Household Income") +
...
#### Maps
```{r}
dots_ethnic_section <- tm_shape(primary_table_title) + tm_dots(size=.1, col="Latinx Ethnic Food Section?" , palette="Set1")
incomemap_with_food_retailers <- tm_shape(incomejoin_test_title) +
             tm_style("watercolor") +
             tm_polygons("Median Household Income") +
...
#### Maps
```{r}
dots_social <- tm_shape(primary_table_title) + tm_dots(size=.1, col="Social Sustainability Signage?" , palette="Set1")
incomemap_with_food_retailers <- tm_shape(incomejoin_test_title) +
             tm_style("watercolor") +
             tm_polygons("Median Household Income") +
