...
{
  # Print("Working...")
  result <- geocode(retail_data$Address[i], output = "latlona", source = "google")
  retail_data$lon[i] <- as.numeric(result[1])
  retail_data$lat[i] <- as.numeric(result[2])
  retail_data$geoAddress[i] <- as.character(result[3])
}
# Write a CSV file containing origAddress to the working directory
write.csv(retail_data, "geocoded.csv", row.names=FALSE)
```
